...
WHERE [synonym_registrator] NOT IN ('Корректировка реализации','Реализация товаров и услуг','Реализация услуг и прочих активов','Заказ клиента')--,'Возврат товаров от клиента'
...
WHERE DK.TIP_DOGOVORA='С покупателем / заказчиком'
--AND DK.GUID IN (0xA22E7085C2A4312A11EABC1470768D37,0x80C500155D01C90111E775BB79B9B8D0)
