...
order by [period],sp.ssylka
 ...
 CREATE TABLE [L1].[dbo].[KADROVAYA_ISTORIYA_SOTRUDNIKOV](
  [PERIOD] [DATETIME2](0) NULL,
  [VIDSOBYTIYA] [VARCHAR](11) NULL,
  [FIZICHESKOE_LITSO_GUID] [BINARY](16) NULL,
  [DOLZHNOST_GUID] [BINARY](16) NULL,
  [ORGANIZATSIYA_GUID] [BINARY](16) NULL,
  [STRUKTURA_PREDPRIYATIYA_GUID] [BINARY](16) NOT NULL,
