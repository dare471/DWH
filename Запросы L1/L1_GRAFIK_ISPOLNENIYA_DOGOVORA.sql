...
CREATE TABLE [L1].[dbo].[GRAFIK_ISPOLNENIYA_DOGOVORA](
	[NOMER_DOGOVORA] [nvarchar](128) NOT NULL,
	[TIP_DOGOVORA] [varchar](50) NULL,
	[STATUS] [varchar](50) NULL,
	[DOGOVOR_GUID] [binary](16) NOT NULL,
	[DATA_PO_GRAFIKU] [date] NULL,
	[PROTSENT_OPLATY] [numeric](10, 2) NOT NULL,
	[SUMMA_OPLATY] [numeric](18, 2) NOT NULL,
	[PERIOD] [date] NULL,
